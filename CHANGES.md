...
- [UPGRADED] `ibm-cloud-sdk-core` peerDependency to version `5.4.12` to match version provided from `@ibm-cloud/cloudant`.
- [UPGRADED] `axios` peerDependency to version `1.15.2` to match version provided from `@ibm-cloud/cloudant`.
...
# 2.11.13 (2026-02-12)
- [UPGRADED] `@ibm-cloud/cloudant` dependency to version `0.12.15`.
- [UPGRADED] `ibm-cloud-sdk-core` peerDependency to minimum version `5.4.6` to match version provided from `@ibm-cloud/cloudant`.
...
- [UPGRADED] `@ibm-cloud/cloudant` dependency to version `0.12.13`.
- [UPGRADED] `ibm-cloud-sdk-core` peerDependency to minimum version `5.4.5` to match version provided from `@ibm-cloud/cloudant`.
- [UPGRADED] `axios` peerDependency to minimum version `1.13.2` to avoid broken `1.13.0` version.
